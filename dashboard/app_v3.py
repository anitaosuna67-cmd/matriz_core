...
load_dotenv()
NEWSAPI_KEY = os.getenv("NEWSAPI_KEY", "8e591b7bf8e840e7bcf6a375ec49cc26")
...
# --- 4. MOTOR OSINT V2: NEWSAPI + FALLBACK RSS ---
...
KEYWORDS_REALES = {
    ...
    "Custodia del primer umbral, registro de entrada":           ["border control biometric", "digital identity system"],
    "Registro perpetuo de acciones y consecuencias":             ["permanent surveillance record", "social credit system"],
    "Aplicación de consecuencias jurisdiccionales":              ["international court enforcement", "sanctions regime"],
    "Administración de flujos de poder entre facciones":         ["power transition geopolitical", "faction negotiation"],
    "Separación y delimitación de jurisdicciones":               ["sovereignty dispute territory", "jurisdiction conflict"],
    "Diálogo entre órdenes jerárquicos distintos":               ["backchannel diplomacy elite", "secret negotiation"],
    "Consolidación de estructuras de autoridad":                 ["authoritarian consolidation", "power centralization"],
    "Mantenimiento de orden en territorios extensos":            ["empire administration control", "territorial governance"],
    "Control de fronteras nómadas e inestables":                 ["nomadic population control", "migration border policy"],
    "Visión de largo plazo, planificación de ciclos":            ["long term strategic planning elite", "100 year plan"],
    "Análisis estratégico de estructuras en conflicto":          ["strategic analysis think tank", "conflict structure"],
    "Discernimiento filosófico aplicado al gobierno":            ["philosophy governance technocracy", "expert rule"],
    "Memoria institucional, archivo de pactos y tratados":       ["treaty archive international law", "institutional memory"],
    "Transmisión de conocimiento entre generaciones de poder":   ["dynastic power transmission", "elite continuity"],
    "Expansión ordenada de jurisdicción territorial":            ["territorial expansion legal", "jurisdiction expansion"],
    "Calibración de ciclos temporales y astronómicos":           ["astronomical cycle governance", "calendar reform"],
    "Medición de fuerzas entre órdenes en tensión":              ["power measurement geopolitical", "force balance"],
    "Instrumentos de vigilancia y detección temprana":           ["early warning surveillance system", "intelligence detection"],
    "Comunicación vertical entre capas del sistema":             ["hierarchical communication encrypted", "chain of command"],
    "Codificación de mensajes entre rangos":                     ["encrypted communication military", "code system"],
    "Transmisión de instrucciones sin pérdida semántica":        ["precise instruction protocol", "command clarity"],
    "Custodia de recursos estratégicos y minerales":             ["strategic mineral control", "resource custody"],
    "Acumulación y redistribución controlada de capital":        ["capital accumulation redistribution", "wealth control"],
    "Gestión de rutas comerciales y flujos de valor":            ["trade route control", "value flow management"],
    "Codificación y aplicación de sistemas legales":             ["legal code enforcement", "law system application"],
    "Derecho institucional, jurisprudencia y precedente":        ["institutional law precedent", "jurisprudence control"],
    "Ley sagrada, regulación de lo puro e impuro":               ["religious law regulation", "sacred law governance"],
    "Sistemas de vigilancia e inteligencia centralizada":        ["centralized intelligence surveillance", "NSA GCHQ"],
    "Red de informantes y agentes encubiertos":                  ["informant network undercover agent", "intelligence asset"],
    "Contraespionaje y purga de infiltraciones":                 ["counterintelligence purge", "mole hunt"],
    "Administración de ciclos temporales y calendarios":         ["calendar control reform", "time system governance"],
    "Sincronización de rituales con ciclos astronómicos":        ["astronomical event governance", "celestial cycle policy"],
    "Marcadores de equinoccios y solsticios como umbrales":      ["solstice equinox event", "celestial threshold"],
    "Control demográfico y administración de poblaciones":       ["demographic control population policy", "birth rate governance"],
    "Censos, clasificación y registro de poblaciones":           ["census data population control", "classification system"],
    "Regulación de roles sociales y estratificación":            ["social stratification policy", "role assignment governance"],
    "Administración del conocimiento técnico y científico":      ["scientific knowledge control", "research governance"],
    "Traducción y preservación de corpus filosóficos":           ["philosophy preservation translation", "knowledge archive"],
    "Síntesis de tradiciones del conocimiento en poder":         ["knowledge synthesis power", "intellectual tradition control"],
    "Formación y mantenimiento de tratados entre potencias":     ["treaty formation major powers", "alliance maintenance"],
    "Diplomacia de alto nivel y protocolo de alianzas":          ["high level diplomacy protocol", "alliance formation"],
    "Etiqueta del poder, formalización de jerarquías":           ["power protocol formalization", "hierarchy ceremony"],
    "Legitimación del liderazgo ante poblaciones":               ["leadership legitimacy public", "political legitimation"],
    "Oratoria y persuasión al servicio del orden":               ["political rhetoric persuasion", "oratory power"],
    "Unificación de autoridad espiritual y temporal":            ["church state authority", "spiritual temporal power"],
    "Estructuras de obediencia absoluta y disciplina":           ["absolute obedience structure", "military discipline"],
    "Jerarquía militar y cadena de mando":                       ["military hierarchy command", "chain of command structure"],
    "Honor y lealtad como mecanismos de control":                ["loyalty control mechanism", "honor code governance"],
    "Gestión de puntos de no retorno y umbrales críticos":       ["point of no return decision", "critical threshold management"],
    "Defensa de pasos estratégicos y cuellos de botella":        ["strategic chokepoint defense", "bottleneck control"],
    "Control de migraciones y desplazamientos poblacionales":    ["migration control population movement", "displacement governance"],
    "Creación y regulación de sistemas de valor":                ["value system creation", "currency regulation"],
    "Instrumentos financieros y deuda como control":             ["debt instrument control", "financial weapon"],
    "Banca central y monopolio de la emisión":                   ["central bank monopoly", "currency issuance control"],
    "Creación de sistemas de escritura como tecnología de poder":["writing system power technology", "literacy control"],
    "Codificación del poder en sistemas simbólicos":             ["symbolic power system", "semiotics control"],
    "Democratización controlada del lenguaje escrito":           ["controlled literacy spread", "writing access governance"],
    "Infraestructura de movilidad y control territorial":        ["infrastructure control territory", "mobility governance"],
    "Arquitectura defensiva y demarcación de fronteras":         ["defensive architecture border", "frontier demarcation"],
    "Monumentalización del poder como señal de permanencia":     ["monument power permanence", "architecture dominance"],
    "Guardián del umbral entre el ser y el no-ser":              ["threshold guardian philosophy", "being nonbeing"],
    "Disolución de estructuras que cruzaron el umbral":          ["institutional dissolution collapse", "structure breakdown"],
    "Reintegración post-disolución en nueva forma":              ["post collapse reintegration", "new order formation"],
    "Tecnología bélica y proyección de fuerza ordenada":         ["military technology force projection", "weapons system"],
    "Estrategia de expansión y consolidación territorial":       ["territorial expansion strategy", "consolidation military"],
    "Doctrina militar y aplicación sistemática de la fuerza":    ["military doctrine application", "systematic force use"],
    "Custodia de linajes y pureza genealógica":                  ["lineage custody genealogy", "bloodline control"],
    "Selección y preservación de rasgos en poblaciones":         ["trait selection population", "eugenics program"],
    "Aristocracia hereditaria como mecanismo de continuidad":    ["hereditary aristocracy continuity", "dynastic mechanism"],
    "Unificación de autoridad espiritual como poder político":   ["spiritual political authority", "theocracy power"],
    "Canon, ortodoxia y expulsión de lo heterodoxo":             ["orthodoxy canon enforcement", "heterodox expulsion"],
    "Ley sagrada como código total de organización social":      ["sacred law social organization", "sharia halakha code"],
    "Control de medios de producción y cadenas de valor":        ["means of production control", "supply chain dominance"],
    "Monopolio de recursos estratégicos industriales":           ["industrial resource monopoly", "strategic asset control"],
    "Control de fuentes energéticas como palanca geopolítica":   ["energy source geopolitical leverage", "oil gas control"],
    "Control de medios de reproducción y difusión":              ["media reproduction control", "information diffusion"],
    "Narrativa hegemónica y agenda setting":                     ["hegemonic narrative agenda setting", "media control"],
    "Algoritmos de filtrado y curación de realidad":             ["algorithm filter reality curation", "AI content control"],
    "Mantenimiento del statu quo como tecnología de poder":      ["status quo maintenance power", "stability technology"],
    "Institucionalización del orden internacional":              ["international order institution", "global governance"],
    "Multilateralismo como mecanismo de contención":             ["multilateralism containment mechanism", "UN NATO"],
    "Custodia del orden biológico y las taxonomías naturales":   ["biological order taxonomy", "species classification control"],
    "Regulación de la selección y adaptación controlada":        ["controlled selection adaptation", "directed evolution"],
    "Herencia como código de transmisión de orden":              ["genetic inheritance order transmission", "epigenetics control"],
    "Geometría como fundamento del orden cósmico":               ["sacred geometry cosmic order", "mathematical governance"],
    "Número y proporción como lenguaje del control":             ["number proportion control language", "mathematical power"],
    "Armonía de esferas como modelo de jerarquía perfecta":      ["harmony spheres hierarchy model", "cosmic order perfect"],
    "Fuente primordial de toda autoridad en el sistema":         ["primordial authority source", "ultimate power origin"],
    "Registro eterno, el libro que no se borra":                 ["eternal record immutable", "permanent archive"],
    "Ejecución final de la voluntad del sistema completo":       ["final execution system will", "ultimate enforcement"],
    "El sellado — cierre del ciclo completo del sistema":        ["system cycle closure seal", "end cycle completion"],
    "Vigilancia sin intervención — registro eterno del sistema": ["passive surveillance eternal record", "observation without intervention"],
    "Gobierno del Aire — administración elemental total":        ["atmospheric control weather", "air surveillance drone"],
    "Gobierno del Agua — administración elemental total":        ["water control geopolitics", "ocean surveillance"],
    "Gobierno del Tierra — administración elemental total":      ["land control territory", "earth resources governance"],
    "Gobierno del Fuego — administración elemental total":       ["energy fire control", "nuclear power governance"],
...
def buscar_noticias_entidad(funcion: str, nombre: str) -> list:
    ...
    try:
        kw_simple = keywords[0] if keywords else "geopolitics"
        rss_url = f"https://news.google.com/rss/search?q={urllib.parse.quote(kw_simple)}&hl=en&gl=US&ceid=US:en"
        ...
        return [{
            ...
            "fecha":       item.find("pubDate").text[:16] if item.find("pubDate") is not None else "",
            "imagen":      ""
        } for item in items]
    except Exception:
        return []
...
# --- 6. SISTEMA ENOQUIANO EXPANDIDO + PLANO SEMÁNTICO ---
...
for nombre, rango, legiones, funcion in goetia_72:
    ...
    comandantes.append({"IdNodo": id_nodo, "Comandante": nombre, "Faccion": "IZQUIERDA (Caos)", "Raiz": raiz, "Rango": rango, "Legiones_Str": f"{legiones} Legiones", "Legiones_Num": legiones, "Funcion": funcion, "OSINT": funcion, "Ubicacion": lugar[0], "Cuadrante": cuadrante, "Aethyr": "Ars Goetia"})
...
for nombre, rango, dominio in reyes_enoquianos:
    ...
    comandantes.append({"IdNodo": id_nodo, "Comandante": nombre, "Faccion": "DERECHA (Control)", "Raiz": "YAMIN_DEXIOS", "Rango": rango, "Legiones_Str": f"Elemento: {dominio}", "Legiones_Num": 100, "Funcion": funcion_rey, "OSINT": funcion_rey, "Ubicacion": lugar[0], "Cuadrante": "Q1", "Aethyr": "LIL"})
    if rango not in nodos_por_clase: nodos_por_clase[rango] = []
    nodos_por_clase[rango].append(id_nodo)
...
for i in range(24):
    ...
    comandantes.append({"IdNodo": id_nodo, "Comandante": nombre, "Faccion": "DERECHA (Control)", "Raiz": "BEYN_KRIMA", "Rango": "Anciano", "Legiones_Str": "Dominio: Testimonio Cósmico", "Legiones_Num": 30, "Funcion": funcion_anc, "OSINT": funcion_anc, "Ubicacion": lugar[0], "Cuadrante": "Q1", "Aethyr": "LIL-ARN"})
...
for g in GOBERNADORES_91:
    ...
    comandantes.append({"IdNodo": id_nodo, "Comandante": g["nombre"], "Faccion": "DERECHA (Control)", "Raiz": raiz, "Rango": f"Gobernador {g['aethyr']}", "Legiones_Str": f"Aethyr {g['aethyr']} #{g['num']}", "Legiones_Num": 30, "Funcion": g["funcion"], "OSINT": g["funcion"], "Ubicacion": g["jurisdiccion"], "Cuadrante": g["cuadrante"], "Aethyr": g["aethyr"]})
...
comandantes.append({"IdNodo": id_vigilantes, "Comandante": "Semyaza", "Faccion": "IZQUIERDA (Caos)", "Raiz": "YADA_GINOSKO", "Rango": "Comandantes", "Legiones_Str": "200 Ángeles", "Legiones_Num": 200, "Funcion": "Rebelión e Hibridación Genética", "OSINT": "Rebelión e Hibridación Genética", "Ubicacion": "Monte Hermón (Levante)", "Cuadrante": "Q4", "Aethyr": "Vigilantes"})
...
def generar_mapa_maestro(faccion, c_ling, c_geo, c_bio, c_astro, textos_raw, activar_radar):
    ...
    if "DERECHA" in faccion:
        raices = {
            "YAMIN_DEXIOS": {"desc": "Yamin/Dexios — Autoridad / Centralización", "color": "#3b82f6", "claves": ["YAMIN","DEXIOS","DERECHA","CENTRAL","CONTROL"]},
            "BEYN_KRIMA":   {"desc": "Beyn/Krima — Límites / Vigilancia",          "color": "#60a5fa", "claves": ["BEYN","KRIMA","SEPARACION","VIGILANCIA","FILTRO","LEY"]}
        }
    else:
        raices = {
            "SMOL_ARISTEROS": {"desc": "Smol/Aristeros — Entropía / Disolución",          "color": "#f43f5e", "claves": ["SMOL","ARISTEROS","IZQUIERDA","CAOS","DISOLUCION","REBELION"]},
            "YADA_GINOSKO":   {"desc": "Yada/Ginosko — Ausencia de Discernimiento",       "color": "#fb7185", "claves": ["YADA","GINOSKO","ALTERACION","HIBRIDACION","MUTACION","CONOCIMIENTO"]}
        }
    ...
    for cmd in comandantes_faccion:
        ...
        G.add_node(id_nodo, size=25 if esta_buscando else 12, color=color_nodo,
                   title=f"👑 {id_nodo}\n📍 {cmd['Ubicacion']}\n🔮 Aethyr: {cmd.get('Aethyr','—')}\n⚙️ {cmd['Legiones_Str']}\n📜 {cmd['Funcion']}\n🧭 {cuad_info.get('nombre','—')}")
    ...
    if not c_ling.empty:
        for _, row in c_ling.iterrows():
            ...
            G.add_node(nodo_id, size=15, color="#f8fafc", title=f"📖 {nodo_id}\n{trad}")
            conceptos = str(row.get('Conceptos_Matriz','')).upper()
            conectado = False
            for r_id, info in raices.items():
                if any(clave in conceptos for clave in info["claves"]):
                    G.add_edge(str(r_id), nodo_id, weight=2); conectado = True; break
            ...
            for r_id, info in raices.items():
                for clave in info["claves"]:
                    if clave in contenido.upper():
                        ...
                        G.add_edge(str(r_id), nodo_doc_id, weight=1); break
    ...
    def procesar_capa(df_capa, col_nombre, col_mecanismo, color_nodo, prefijo, icono):
        if not df_capa.empty:
            for _, row in df_capa.iterrows():
                ...
                mecanismo = str(row.get(col_mecanismo,''))
...
def generar_plano_semantico(faccion_filtro=None):
    ...
    for g in GOBERNADORES_91:
        ...
        jx = (g["num"]%7-3)*0.07; jy = (g["num"]%5-2)*0.07
        puntos_plano.append({"nombre":g["nombre"],"tipo":f"Gobernador {g['aethyr']}","cuadrante":g["cuadrante"],"jurisdiccion":g["jurisdiccion"],"funcion":g["funcion"],"faccion":"DERECHA (Control)","x":cx+jx,"y":cy+jy,"color":CUADRANTES_PLANO.get(g["cuadrante"],{}).get("color","#94a3b8"),"size":8,"simbolo":"circle"})
    ...
    for cmd in comandantes:
        ...
        jx = (hash(cmd["Comandante"])%7-3)*0.07; jy = (hash(cmd["Comandante"])%5-2)*0.07
        puntos_plano.append({"nombre":cmd["Comandante"],"tipo":cmd["Rango"],"cuadrante":cuad,"jurisdiccion":cmd["Ubicacion"],"funcion":cmd["Funcion"],"faccion":"IZQUIERDA (Caos)","x":cx+jx,"y":cy+jy,"color":CUADRANTES_PLANO.get(cuad,{}).get("color","#e11d48"),"size":10 if cmd["Rango"]=="Rey" else 7,"simbolo":"diamond"})

    df_plano = pd.DataFrame(puntos_plano)
    fig = go.Figure()

    for rect in [
        dict(x0=0,x1=1,y0=0,y1=1,fill="rgba(29,78,216,0.08)"),
        dict(x0=0,x1=1,y0=-1,y1=0,fill="rgba(37,99,235,0.08)"),
        dict(x0=-1,x1=0,y0=0,y1=1,fill="rgba(190,18,60,0.08)"),
        dict(x0=-1,x1=0,y0=-1,y1=0,fill="rgba(225,29,72,0.12)"),
    ]:
        fig.add_shape(type="rect",x0=rect["x0"],x1=rect["x1"],y0=rect["y0"],y1=rect["y1"],fillcolor=rect["fill"],line=dict(color="#1e293b",width=1))
    ...
    if not df_plano.empty:
        for faccion, group in df_plano.groupby("faccion"):
            fig.add_trace(go.Scatter(x=group["x"],y=group["y"],mode="markers",name=faccion,
                marker=dict(size=group["size"].tolist(),color=group["color"].tolist(),symbol=group["simbolo"].tolist(),line=dict(color="#0b0f19",width=0.5)),
                text=group["nombre"],customdata=group[["cuadrante","jurisdiccion","funcion","tipo"]].values,
                hovertemplate="<b>%{text}</b><br>%{customdata[3]}<br>Cuadrante: %{customdata[0]}<br>%{customdata[1]}<br>%{customdata[2]}<extra></extra>"))

    fig.add_trace(go.Scatter(x=[-0.5],y=[-0.5],mode="markers+text",name="★ Jonás 4:11",
        ...
        hovertemplate="<b>★ JONÁS 4:11 — TEXTO GENERADOR</b><br>לֹא־יָדַע אִישׁ בֵּין־יְמִינוֹ לִשְׂמֹאלוֹ<extra></extra>"))
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(x=0.75,y=0.85,text="Q1 — CONTROL CON LÍMITES<br>YAMIN + BEYN",showarrow=False,font=dict(color="#3b82f6",size=10),align="center"),
            dict(x=0.75,y=-0.85,text="Q2 — AUTORIDAD POR DISCERNIMIENTO<br>YAMIN + YADA",showarrow=False,font=dict(color="#2563eb",size=10),align="center"),
            dict(x=-0.75,y=0.85,text="Q3 — CAOS CONTENIDO<br>SMOL + BEYN",showarrow=False,font=dict(color="#be123c",size=10),align="center"),
            dict(x=-0.75,y=-0.85,text="Q4 — INDISTINCIÓN TOTAL<br>SMOL + YADA",showarrow=False,font=dict(color="#e11d48",size=10),align="center"),
            dict(x=0.0,y=-0.22,text="UMBRAL",showarrow=False,font=dict(color="#0ea5e9",size=9),align="center"),
            dict(x=1.08,y=0,text="YAMIN →<br>יָמִין",showarrow=False,font=dict(color="#3b82f6",size=10)),
            dict(x=-1.08,y=0,text="← SMOL<br>שְׂמֹאל",showarrow=False,font=dict(color="#e11d48",size=10)),
            dict(x=0,y=1.08,text="↑ BEYN / בֵּין",showarrow=False,font=dict(color="#60a5fa",size=10),align="center"),
            dict(x=0,y=-1.08,text="↓ YADA / יָדַע",showarrow=False,font=dict(color="#fb7185",size=10),align="center"),
        ],
        legend=dict(bgcolor="#0f172a",bordercolor="#1e293b",borderwidth=1),
        margin=dict(l=40,r=40,t=60,b=40),
        title=dict(text="Plano Semántico — Jonás 4:11  |  לֹא־יָדַע אִישׁ בֵּין־יְמִינוֹ לִשְׂמֹאלוֹ",font=dict(color="#e2e8f0",size=14)),
        height=650
    )
    return fig

# --- 9. TABS ---
tab_core, tab_geo, tab_plano, tab_radar, tab_predict, tab_timeline, tab0, tab1, tab2, tab3, tab4, tab_arq = st.tabs([
    "🔄 Enjambre Jerárquico", "🗺️ Mapa Geo-Densidad", "🧭 Plano Semántico", "📡 Radar en Vivo",
...
with tab_core:
    ...
    m4.metric("Infraestructura", len(c_geo)+len(c_bio))
    m5.metric("Ventanas Astro", len(c_astro))

with tab_geo:
    st.subheader("🗺️ Mapeo Geopolítico Histórico")
    df_zonas["Hover"] = df_zonas.apply(lambda r: f"<b>{r['Ubicacion']}</b><br>Jerarcas: {r['Total_Jerarcas']}<br>Entidades: {r['Entidades']:,.0f}<br>Población: {r['Poblacion']:,.0f}<br>Densidad: 1/{r['Ratio']}", axis=1)
...
with tab_plano:
    ...
    with col_p1:
        ...
        **Base textual:** `יונה ד:יא` — *"no sabe un hombre entre su derecha y su izquierda"*
        ...
        """)
    with col_p2:
        filtro_faccion = st.selectbox("Filtrar:", ["Todas","DERECHA (Control)","IZQUIERDA (Caos)"])
        filtro = None if filtro_faccion=="Todas" else filtro_faccion
        st.markdown("**Por cuadrante:**")
        enoc_q = {"Q1":0,"Q2":0,"UMBRAL":0}
        goet_q = {"Q3":0,"Q4":0}
        for g in GOBERNADORES_91:
            if g["cuadrante"] in enoc_q: enoc_q[g["cuadrante"]] += 1
        for c in comandantes:
            if c["Faccion"]=="IZQUIERDA (Caos)" and c.get("Cuadrante") in goet_q: goet_q[c["Cuadrante"]] += 1
        for k,v in {**enoc_q,**goet_q}.items():
    ...
    st.markdown("---")
    st.subheader("📋 91 Gobernadores")
    df_gob = pd.DataFrame([{"Núm":g["num"],"Nombre":g["nombre"],"Aethyr":g["aethyr"],"Cuadrante":g["cuadrante"],"Jurisdicción":g["jurisdiccion"],"Función":g["funcion"]} for g in GOBERNADORES_91])
    cuad_f = st.multiselect("Filtrar cuadrante:", ["Q1","Q2","UMBRAL"], default=["Q1","Q2","UMBRAL"])
    st.dataframe(df_gob[df_gob["Cuadrante"].isin(cuad_f)], use_container_width=True, hide_index=True)

# --- PESTAÑA RADAR EN VIVO ---
with tab_radar:
    st.subheader("📡 Radar en Vivo — Movimientos de Entidades")
    st.caption("Noticias de los últimos 7 días mapeadas a funciones de cada jerarquía. Fuente: NewsAPI + fallback RSS.")

    if not NEWSAPI_KEY:
        st.warning("⚠️ No se detectó NEWSAPI_KEY en el archivo .env. El radar usará fallback RSS (menos preciso).")

    col_r1, col_r2, col_r3 = st.columns(3)
    with col_r1:
        faccion_radar = st.selectbox("Facción:", ["Todas","DERECHA (Control)","IZQUIERDA (Caos)"], key="rad_fac")
    with col_r2:
        fuente_radar = st.selectbox("Fuente jerárquica:", ["Todas","Goetia","Gobernadores Enoquianos","Reyes Elementales","Vigilantes"], key="rad_src")
    with col_r3:
        cuad_radar = st.selectbox("Cuadrante semántico:", ["Todos","Q1","Q2","Q3","Q4","UMBRAL"], key="rad_cuad")
    ...
    for cmd in comandantes:
        ...
        elif fuente_radar=="Vigilantes":            src_ok = cmd.get("Aethyr")=="Vigilantes"
        if fac_ok and cuad_ok and src_ok:
            entidades_radar.append(cmd)

    entidades_radar = entidades_radar[:15]

    if not entidades_radar:
        st.info("No hay entidades que coincidan con los filtros.")
    else:
        st.markdown(f"Rastreando **{len(entidades_radar)}** entidades (límite 15 por consulta).")
        buscar = st.button("🔍 Buscar Noticias Ahora", type="primary")

        if buscar:
            progress = st.progress(0)
            resultados_radar = {}
            for i, ent in enumerate(entidades_radar):
                noticias = buscar_noticias_entidad(ent["Funcion"], ent["Comandante"])
                if noticias:
                    resultados_radar[ent["IdNodo"]] = {"entidad": ent, "noticias": noticias}
                progress.progress((i+1)/len(entidades_radar))
            progress.empty()

            if not resultados_radar:
                st.warning("No se encontraron noticias. Verificá la API key en .env o intentá de nuevo.")
            else:
                total_noticias = sum(len(v["noticias"]) for v in resultados_radar.values())
                st.success(f"✅ {total_noticias} noticias encontradas para {len(resultados_radar)} entidades.")
                st.markdown("---")

                for id_nodo, data in resultados_radar.items():
                    ent = data["entidad"]
                    noticias = data["noticias"]
                    cuad_info = CUADRANTES_PLANO.get(ent.get("Cuadrante","Q1"),{})
                    color_ent = cuad_info.get("color","#94a3b8")

                    with st.expander(f"{ent['IdNodo']} — {len(noticias)} señales", expanded=False):
                        c1,c2,c3 = st.columns(3)
                        c1.markdown(f"**Facción:** <span style='color:{color_ent}'>{ent['Faccion']}</span>", unsafe_allow_html=True)
                        c2.markdown(f"**Cuadrante:** <span style='color:{color_ent}'>{cuad_info.get('nombre','—')}</span>", unsafe_allow_html=True)
                        c3.markdown(f"**Función:** {ent['Funcion']}")
                        st.markdown("---")
                        for n in noticias:
                            st.markdown(f"""
                            <div style='background:#0f172a;border-left:3px solid {color_ent};padding:12px 16px;margin:8px 0;border-radius:0 8px 8px 0'>
                                <div style='display:flex;justify-content:space-between;margin-bottom:4px'>
                                    <small style='color:#64748b'>{n.get("fuente","—")}</small>
                                    <small style='color:#64748b'>{n.get("fecha","")}</small>
                                </div>
                                <b style='color:#e2e8f0;font-size:14px'>{n.get("titulo","")}</b><br>
                                <small style='color:#94a3b8'>{str(n.get("descripcion",""))[:180]}...</small><br>
                                <a href='{n.get("url","#")}' target='_blank' style='color:{color_ent};font-size:12px;text-decoration:none'>→ Ver fuente completa</a>
                            </div>
                            """, unsafe_allow_html=True)

        with st.expander("🔑 Keywords activos por entidad", expanded=False):
            rows = []
            for ent in entidades_radar:
                kws = KEYWORDS_REALES.get(ent["Funcion"], KEYWORDS_REALES["default"])
                rows.append({"Entidad":ent["Comandante"],"Función":ent["Funcion"][:60],"Keywords":" | ".join(kws[:2]),"Cuadrante":ent.get("Cuadrante","—"),"Facción":ent["Faccion"]})
...
with tab_predict:
    ...
    if st.button("Analizar Convergencia", type="primary"):
        ...
        if fac_geo==fac_bio:
            ...
            st.progress(0.40)
            st.markdown(f"<h3 style='color:orange'>⚡ FRICCIÓN ESTRUCTURAL (40%): {var_geo} choca con {var_bio}.</h3>", unsafe_allow_html=True)
